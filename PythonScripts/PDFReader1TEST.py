...
testLs = [item.replace(' ','') for item in accountNum]
print(testLs)
testLs2 = []
for item in testLs:
    testLs2.append(''.join(list(filter(str.isdigit, item))))
print(testLs2)

# for item in [re.split('\d+',item) for item in accountNum]:
#     testLs += item
# for item in [re.split('\D+',item) for item in accountNum]:
#     testLs2 += item
# print(testLs)
# print(testLs2)
# print(dict(zip(testLs,testLs2)))
# for k,v in zip(testLs,testLs2):
#     print(k,v)
